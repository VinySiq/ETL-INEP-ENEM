...
# S3 Uploader with Progress Bar - check this code in https://github.com/VinySiq/AWS-S3-Uploader-ProgressBar
...
upload_s3('datalake-enem2020-vinisiq','dadosINEP.csv','data/dadosINEP.csv')
